...
- Mobile application source: `d2a67c4` (later tour/documentation-only commits do not change the APK).
...
[Completion status](https://github.com/CineMatePlus/cinemate_backend/blob/codex/portfolio-completion/docs/completion-status.md) records remote CI and publication gates. iOS/web/desktop are unverified.
